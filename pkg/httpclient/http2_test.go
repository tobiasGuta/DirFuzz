...
func TestSendHTTP2Request(t *testing.T) {
	...
	tests := []struct {
		...
		{"https://http2.golang.org/", "GET", 200},
		{"https://http2.golang.org/", "HEAD", 200},
	}
...
func TestSendHTTP2RequestWithHeaders(t *testing.T) {
	...
	resp, err := SendHTTP2Request(ctx, "https://http2.golang.org/", "GET", headers, "", 10*time.Second, true)
	if err != nil {
...
func TestSendHTTP2RequestTimeout(t *testing.T) {
	...
	// This should timeout
	_, err := SendHTTP2Request(ctx, "https://http2.golang.org/", "GET", nil, "", 1*time.Millisecond, true)
	if err == nil {
